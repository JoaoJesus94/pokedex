...
// export const mockedPokemonListResponse: InfiniteQueryObserverSuccessResult<NamedAPIResourceList> = {
// 	data: {
// 		pageParams: [null],
// 		pages: [
// 			{
...
export const mockedInfinitePokemonListResponse: NamedAPIResourceList = {
	count: 1154,
	next: 'https://pokeapi.co/api/v2/pokemon/?offset=20&limit=20',
	previous: null,
	results: [
